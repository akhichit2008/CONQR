...
export default function KineticGrid({
  ...
  const draw = useCallback(
    (now: number) => {
      ...
      const theme = {
        ...
        monochrome: {
          bg: "#030000",
          lineActive: { r: 178, g: 158, b: 136, a: 0.9 },
          nodeActive: { r: 178, g: 158, b: 136, a: 1.0 },
          glow: "178,158,136",
          ripple: "9,199,196",
        },
      }[globalColor ?? "default"];
  ...
  const animate = useCallback(
    (now: number) => {
      ...
      const stillSettling = Math.abs(t.x - m.x) > 0.05 || Math.abs(t.y - m.y) > 0.05;
      if (stillSettling) {
      ...
      if (needsDrawRef.current || stillSettling || hasRipples) {
        draw(now);
  ...
  return (
    <div
      className={cn(
        ...
        globalColor === "monochrome" ? "bg-[#030000]" : "bg-[#161618]",
        className,
      )}
    >
      <canvas
