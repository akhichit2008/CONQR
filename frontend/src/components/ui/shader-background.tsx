...
const fsSource = `
  ...
  const vec4 lineColor = vec4(0.698, 0.620, 0.533, 1.0);
  ...
  void main() {
    ...
    vec4 lines = vec4(0.0);
    vec4 bgColor1 = vec4(0.01, 0.012, 0.035, 1.0);
    vec4 bgColor2 = vec4(0.047, 0.03, 0.275, 1.0);
...
function initShaderProgram(gl: WebGLRenderingContext, vertexSource: string, fragmentSource: string): WebGLProgram | null {
