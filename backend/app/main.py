...
from app.api import auth, health, match
from app.database import Base, SessionLocal, engine
from app.models import ngo, user  # noqa: F401 - registers the models on Base.metadata
...
# The Vite dev server runs on 5173 by default. allow_credentials is required
